...
class PublishedPost(models.Model):
    ...
    facebook_page = models.ForeignKey(FacebookPage, on_delete=models.CASCADE)
    scheduled_post = models.OneToOneField(ScheduledPost, on_delete=models.CASCADE, null=True, blank=True)
...
class AIConfiguration(models.Model):
    ...
    model = models.CharField(max_length=100, default='gpt-3.5-turbo', verbose_name="Modelo da IA")
